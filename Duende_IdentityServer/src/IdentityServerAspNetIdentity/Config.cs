...
/// </summary>
    public static IEnumerable<IdentityResource> IdentityResources =>
        ...
        { 
            // Each IdentityResource could be able to contain more then one claims.
            // The list of claim should be included in a requested resource name.
            new IdentityResources.OpenId(), // id
            new IdentityResources.Profile(), // email , username , familyname
            new IdentityResource("job", new[] {"Job_Title"})  // Job_title 
        };
        ...
        new Client[] 
            { 
                ...
                new Client{
                    ...
                    // The address where to redirect back to the client server after login.
                    RedirectUris = {"https://localhost:7133/signin-oidc"},

                    // The address where to redirect back to the client server after logout.
